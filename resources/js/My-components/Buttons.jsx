...
export const HrefButtonOff = ({href, nama, color, classIcon}) => {
  if(color == 1){
  return (
    <Link href={href} class="text-gray-800 border border-gray-800 hover:bg-gray-600 hover:bg-opacity-5 font-medium rounded-md text-sm px-5 py-1.5">{nama}<i className={classIcon}></i></Link>
    )}else{
      return (
